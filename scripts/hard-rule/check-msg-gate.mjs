...
// `onMessage.addListener(` occurrence must call `classifyInbound(` within a small fixed
// window of lines forward from the addListener line (verification-loop campaign, card V3).
//
...
/**
 * Pure: find every `onMessage.addListener(` line in `source` and check whether
