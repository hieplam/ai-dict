# Campaign runner record — onboarding-category-c

> Collapsed from `docs/tribe/campaigns/onboarding-category-c/` (2026-08-07 docs audit): the runner's
...
# Campaign report: onboarding-category-c

- Run started: 2026-07-17T02:17:03.800Z
- Run ended: 2026-07-17T02:46:42.978Z
- Exit code: 3 (session_incomplete)

Stats: 0 shipped, 0 escalated, 0 blocked, 6 not reached.
...
## STOP sentinel (verbatim)

> stopped by owner order 2026-07-17: livelock bug — sessions background long work then end their turn
