...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| Hard-rule scanners (7)        | `bun run lint` (runs `bun scripts/hard-rule/run-all.mjs`)                                                    | Named invariants below — the registry is `scripts/hard-rule/`, discovered by filename, never hardcoded                                                                                                                                       | commit + CI |
...
| — `check-live-e2e-purity.mjs` | (same)                                                                                                       | `rule-live-e2e-purity`: a `*.live.spec.ts` file never imports a mock helper or calls `context.route`/`page.route`/`routeFromHAR`                                                                                                             | commit + CI |
